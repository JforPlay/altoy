    ...
    const NaviViewer = {
        ...
        createMemoryCard(memory) {
            ...
            img.addEventListener('error', function(e) {
                if (this.src !== window.location.origin + '/altoy/assets/img/placeholder.png' && !this.dataset.errorHandled) {
        ...
        showPolaroidDetail(polaroid) {
            ...
            const placeholderPath = window.location.origin + '/altoy/assets/img/placeholder.png';
