...
export const PAGE_CATALOG = [
    ...
    { key: 'CN_PREVIEW',        path: 'shipgirl/cn-preview/',        name: 'CN 선행 컨텐츠',       description: '중국 서버 선행 함순이/스킨 미리보기',    icon: 'update',       category: '함순이' },
...
export const NAV_STRUCTURE = [
    ...
    },
    {
        label: '정보/도구모음',
        columns: [
            { title: '각종 계산기/도구', keys: ['MAP_VIEWER', 'BOSS_VIEWER', 'ISLAND', 'EVENT_TIMELINE'] },
    ...
    },
    {
        ...
        columns: [
            ...
            { title: '인게임 일러스트들', keys: ['LOADINGBG', 'COMIC_VIEWER', 'GALLERYPIC', 'ISLAND_MISC'] },
