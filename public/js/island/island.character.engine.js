...
async function init(sharedData) {
    try {
        ...
        window.IslandEngine.showError('캐릭터 데이터를 불러오는데 실패했습니다. 페이지를 새로고침해주세요.');
        throw error;
    }
}
 ...
 * Growth rates correspond to limit break levels:
...
export { init, searchCharacters, renderCharacterList, selectCharacter };
