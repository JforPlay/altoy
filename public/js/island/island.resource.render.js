                    ...
                    <div class="resource-costs">
                        ...
                        <div class="cost-items">
                            ${Object.entries(goldConsumption.resources).map(([itemId, data]) => `
                                <div class="cost-item">
                                    <div class="cost-icon">
                                        ${data.icon ? `<img src="https://raw.githubusercontent.com/JforPlay/data_for_toy/main/island/islandprops/${data.icon.split('/').pop()}.webp" alt="${data.name}">` : '📦'}
                                    </div>
    ...
    const html = `
        ...
        return `
                            <div class="tree-node-card upstream" data-recipe-id="${recipeId}">
                                <div class="tree-node-icon">
                                    ${producerItem.icon ? `<img src="https://raw.githubusercontent.com/JforPlay/data_for_toy/main/island/islandprops/${producerItem.icon.split('/').pop()}.webp" alt="${producerItem.name}">` : '📦'}
                                </div>
        ...
        return `
                            <div class="tree-node-card downstream" data-recipe-id="${recipeId}">
                                <div class="tree-node-icon">
                                    ${usageItem.icon ? `<img src="https://raw.githubusercontent.com/JforPlay/data_for_toy/main/island/islandprops/${usageItem.icon.split('/').pop()}.webp" alt="${usageItem.name}">` : '📦'}
                                </div>
                                <div class="tree-node-info">
