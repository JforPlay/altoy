...
def generate_lite_data():
    ...
    # --- Process Ship Info ---
    try:
        with open('data/ship_info_data.json', 'r', encoding='utf-8') as f:
        ...
        with open('data/ship_info_lite.json', 'w', encoding='utf-8') as f:
            json.dump(lite_ship_data, f, ensure_ascii=False, separators=(',', ':')) # Minified
        
        print(f"  - Generated data/ship_info_lite.json ({len(lite_ship_data)} records)")
    ...
    # --- Process Juustagram ---
    try:
        with open('data/juustagram_data.json', 'r', encoding='utf-8') as f:
        ...
        with open('data/juustagram_lite.json', 'w', encoding='utf-8') as f:
            json.dump(lite_juus_data, f, ensure_ascii=False, separators=(',', ':')) # Minified
            
        print(f"  - Generated data/juustagram_lite.json ({len(lite_juus_data)} records)")
